    ...
    <section className="py-24 bg-brand-dark">
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center">
        ...
        <div className="text-center mb-12">
          <p className="text-sm tracking-widest uppercase text-gray-400 mb-2">{t.instagram.handle}</p>
          <h2 className="text-2xl md:text-3xl font-heading text-white">{t.instagram.title}</h2>
        </div>
        ...
        <motion.a
          href="https://www.instagram.com/mpcreativeoficial/"
          target="_blank"
