      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-heading font-light tracking-tight text-white mb-6 leading-tight">
            {t.hero.title_start}<span className="font-bold">{t.hero.title_bold}</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <a href="https://wa.me/5513996584687" target="_blank" rel="noopener noreferrer" className="group relative px-8 py-4 bg-brand-cyan text-brand-dark font-medium rounded-md overflow-hidden w-full sm:w-auto hover:bg-cyan-400 transition-colors">
              <span className="relative z-10 flex items-center justify-center gap-2">
                {t.hero.cta_primary}
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </span>
            </a>
            <a href="#cases" className="px-8 py-4 text-white font-medium rounded-md border border-white/20 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all w-full sm:w-auto text-center">
